...
object Formality extends FieldValueHelpers {
  ...
  def multiSelectField[T](selector: String, values: List[SelectableOption[T]], defaults: List[T], asCheckboxes: Boolean) = {
  ...
  def multiSelectField[T](selector: String, values: List[(T, String)], asCheckboxes: Boolean)(implicit dummy: DummyImplicit) = {
  ...
  def multiSelectField[T](selector: String, values: List[(T, String)], defaults: List[T], asCheckboxes: Boolean)(implicit dummy: DummyImplicit) = {
  ...
  def multiSelectField[T](selector: String, values: List[T], asCheckboxes: Boolean)(implicit valueSerializer: (T)=>String) = {
